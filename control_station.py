...
class Gui(QMainWindow):
    ...
    def __init__(self, parent=None, dh_config_file=None, pox_config_file=None):
        ...
        self.ui.btnUser6.setText('Stop Teach')
        self.ui.btnUser6.clicked.connect(partial(nxt_if_arm_init, 'stopteach'))
        self.ui.btnUser7.setText('Repeat Teach')
        self.ui.btnUser7.clicked.connect(partial(nxt_if_arm_init, 'repeat'))
        self.ui.btnUser8.setText('Teach: Close Grip')
        self.ui.btnUser8.clicked.connect(partial(nxt_if_arm_init, 'teachclosegrip'))
        self.ui.btnUser9.setText('Teach: Open Grip')
        self.ui.btnUser9.clicked.connect(partial(nxt_if_arm_init, 'teachopengrip'))
        self.ui.btnUser10.setText('Pick and Place')
        self.ui.btnUser10.clicked.connect(partial(nxt_if_arm_init, 'pickandplace'))
        self.ui.btnUser11.setText('Detect')
        self.ui.btnUser11.clicked.connect(partial(nxt_if_arm_init, 'detect'))

        #right side buttons
        self.ui.btn_task1.setText('Comp 1')
        self.ui.btn_task1.clicked.connect(partial(nxt_if_arm_init, 'comp1'))
        self.ui.btn_task2.setText('Comp 2')
        self.ui.btn_task2.clicked.connect(partial(nxt_if_arm_init, 'comp2'))
        self.ui.btn_task3.setText('Comp 3')
        self.ui.btn_task3.clicked.connect(partial(nxt_if_arm_init, 'comp3'))
        self.ui.btn_task4.setText('Comp 4')
        self.ui.btn_task4.clicked.connect(partial(nxt_if_arm_init, 'comp4'))
        self.ui.btn_task5.setText('Comp 5')
        self.ui.btn_task5.clicked.connect(partial(nxt_if_arm_init, 'comp5'))
    ...
    def trackMouse(self, mouse_event):
        ...
        if self.camera.DepthFrameRaw.any() != 0:
            ...
            # w_c = w_c - extrinsic[:,-1]
            # w = np.linalg.inv(extrinsic[:,:3]).dot(w_c)
